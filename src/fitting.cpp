...
void fitting(void) {
    ...
    RooRealVar sA("sA","", 2.67535856296606);
    RooRealVar sB("sB","", -0.0297919232131607);
    RooRealVar sC("sC","", 0.000875655010074424);
    RooRealVar sD("sD","", -6.39931447210993e-6);
    RooRealVar sE("sE","", 1.76449313121818e-8);

    //Parameterization Parameters for Alpha -> aM/mu + aB
    RooRealVar aI("aI","", 2.35414268176798e-7);
    RooRealVar aH("aH","", -8.94457703077888e-5);
    RooRealVar aG("aG","", 0.0123075698740946);
    RooRealVar aF("aF","", -1.15337259579094);

    //Parameterization Parameters for N -> nM/mu + nB
    RooRealVar nJ("nJ","", -3.7288683479993);
    RooRealVar nK("nK","", 1.29470379230305);
    ...
    RooFormulaVar n00("n00", "nJ/mu00+nK", RooArgList(nJ,mu00,nK));
    ...
    RooFormulaVar n01("n01", "nJ/mu01+nK", RooArgList(nJ,mu01,nK));
    ...
    RooFormulaVar n02("n02", "nJ/mu02+nK", RooArgList(nJ,mu02,nK));
    ...
    RooFormulaVar n03("n03", "nJ/mu03+nK", RooArgList(nJ,mu03,nK));
    ...
    RooFormulaVar n04("n04", "nJ/mu04+nK", RooArgList(nJ,mu04,nK));
    ...
    RooFormulaVar n05("n05", "nJ/mu05+nK", RooArgList(nJ,mu05,nK));
    ...
    RooFormulaVar n06("n06", "nJ/mu06+nK", RooArgList(nJ,mu06,nK));
    ...
    RooFormulaVar n07("n07", "nJ/mu07+nK", RooArgList(nJ,mu07,nK));
    ...
    RooFormulaVar n08("n08", "nJ/mu08+nK", RooArgList(nJ,mu08,nK));
    ...
    RooFormulaVar n09("n09", "nJ/mu09+nK", RooArgList(nJ,mu09,nK));
    ...
    RooFormulaVar n10("n10", "nJ/mu10+nK", RooArgList(nJ,mu10,nK));
    ...
    RooFormulaVar n11("n11", "nJ/mu11+nK", RooArgList(nJ,mu11,nK));
    ...
    RooFormulaVar n12("n12", "nJ/mu12+nK", RooArgList(nJ,mu12,nK));
    ...
    RooFormulaVar n13("n13", "nJ/mu13+nK", RooArgList(nJ,mu13,nK));
