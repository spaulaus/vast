...
public:
    ...
    unsigned int GetNumberOfCpus() const { return numberOfCpus_; }
    ...
    *   \param [in] a The binning of the histograms */
    ...
    /*! Set the amount of binning on the TOF histograms
*   \param [in] a The binning of the histograms */
    void SetNumberOfCpus(const unsigned int &a) { numberOfCpus_ = a; }
...
private:
    ...
    unsigned int numberOfCpus_; ///< The number of CPUs to use for the fitting.
