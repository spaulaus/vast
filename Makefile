...
SENSOBJS = $(SENSITIVITYO) $(LIMITFINDERO) $(DECAYO) $(BGTCALCULATORO) $(CONFIGURATIONO) $(FILEHANDLERO) $(INTEGRATORO) $(NEUTRONO) $(EFFCALCULATORO) $(ERRORCALCULATORO) $(PARAMCALCULATORO)
